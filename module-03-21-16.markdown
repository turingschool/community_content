...
* Andrew Thompson & Jared Roth - [Make Mod 1 a little easier: Using Atom, Terminal, and other tools](https://gist.github.com/JaredRoth/1e72f28baaf2802e2a20) Make Mod 1 a little easier: Using Atom, Terminal, and other tool with Andrew Thompson and Jared Roth: We are cramming in a ton of tips, shortcuts, and third-party applications that will be ​_incredibly_​ useful throughout Turing, but especially at the beginning.
...
* Student Name - [Topic](http://gist.github.com/username/link-to-my-outline-gist)
* Patrick Hardy - [Lean Methodology][ https://gist.github.com/patrickwhardy/fcc292b756a82c6944528d83449845fd]
* Christopher Soden - Using Atom's Merge Conflicts package

#### Blog Posts for turing.io/blog (*Limit 2*)

* Student Name - [Blog Title](http://gist.github.com/username/link-to-my-outline-gist)
* July Tran - Posse Update
* Mark Miranda - [Non-relational Databases](https://medium.com/@notmarkmiranda/a-students-limited-view-of-non-relational-databases-f07af8ca4891#.gg8pe35eo)

#### Screencasts for turing.io/blog (*Limit 2*)

* Student Name - [Screencast Title](http://gist.github.com/username/link-to-my-outline-gist)
* Matt Pindell - Using Rust code from within Ruby using Foreign Function Interface
* Thom Pickett - [Rails Migrations](https://gist.github.com/thompickett/c26edea685f194f2cfa08080cf64dde5)

#### Student-Led Electives

* Student Name - [Elective Topic](http://gist.github.com/username/link-to-my-outline-gist)
* Hedy Woo & Nate Venn [Getting Started with Vim Dotfile] (https://gist.github.com/thePaulista/ae4b09879a1ea8758795)
* Sal Espinosa - [Just Enough HTML and SASS (to get you through mod 2)](https://gist.github.com/s-espinosa/9c2406709f1887a9897522c3d107ae72)
