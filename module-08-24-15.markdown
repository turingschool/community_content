...
Slot 1:
* Michael Dorrance - [Intro to HTML5 Mobile Apps with Ionic]() (2 hours)
  - Gain an understanding of hybrid mobile apps
  - A high-level overview of Angular JS and Cordova
  - Introduce [Ionic Framework](http://ionicframework.com/)
  - Build a Hello World Mobile app and view it on your device
